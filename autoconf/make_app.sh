...
clear; clear;
rm -rf $OUTPUT_CODE_DIR/$APP_NAME.app $OUTPUT_CODE_DIR/$APP_NAME
...
##copy the  files, THESE COMMANDS MUST COME BEFORE THOSE MAKING REPLACEMENTS IN THE INIT FILE, OTHERWISE THREE WIL BE A MISTAKE
...
ln -f $INPUT_CODE_DIR/main $OUTPUT_CODE_DIR/$APP_NAME.app/Contents/MacOS/$APP_NAME
