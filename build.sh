...
link_list "$LIBWX_COCOAU_XRC_NAME" "$LIBWX_COCOAU_CORE_NAME $LIBICONV_NAME $LIBWX_BASEU_XML_NAME $LIBWX_BASEU_NAME $LIBWX_COCOAU_HTML_NAME $LIBJPEG_NAME $LIBPCRE2_NAME $LIBTIFF_NAME $LIBCURL_NAME"
link_list "$LIBWX_COCOAU_HTML_NAME" "$LIBWX_COCOAU_CORE_NAME $LIBICONV_NAME $LIBWX_BASEU_XML_NAME $LIBWX_BASEU_NAME $LIBJPEG_NAME $LIBPCRE2_NAME $LIBTIFF_NAME $LIBCURL_NAME"
link_list "$LIBWX_BASEU_NAME" "$LIBICONV_NAME $LIBJPEG_NAME $LIBPCRE2_NAME $LIBTIFF_NAME $LIBCURL_NAME"
link_list "$LIBWX_COCOAU_QA_NAME" "$LIBWX_COCOAU_CORE_NAME $LIBICONV_NAME $LIBWX_BASEU_XML_NAME $LIBWX_BASEU_NAME $LIBWX_COCOAU_HTML_NAME $LIBJPEG_NAME $LIBPCRE2_NAME $LIBTIFF_NAME $LIBCURL_NAME"
link_list "$LIBWX_COCOAU_CORE_NAME" "$LIBICONV_NAME $LIBWX_BASEU_XML_NAME $LIBWX_BASEU_NAME $LIBWX_COCOAU_HTML_NAME $LIBJPEG_NAME $LIBPCRE2_NAME $LIBTIFF_NAME $LIBCURL_NAME"
link_list "$LIBWX_COCOAU_HTML_NAME" "$LIBWX_COCOAU_CORE_NAME $LIBICONV_NAME $LIBWX_BASEU_XML_NAME $LIBWX_BASEU_NAME $LIBJPEG_NAME $LIBPCRE2_NAME $LIBTIFF_NAME $LIBCURL_NAME"
link_list "$LIBWX_BASEU_XML_NAME" "$LIBWX_COCOAU_CORE_NAME $LIBICONV_NAME  $LIBWX_BASEU_NAME $LIBWX_COCOAU_HTML_NAME $LIBJPEG_NAME $LIBPCRE2_NAME $LIBTIFF_NAME $LIBCURL_NAME"
link_list "$LIBWX_BASEU_NET_NAME" "$LIBWX_COCOAU_CORE_NAME $LIBICONV_NAME $LIBWX_BASEU_NAME $LIBJPEG_NAME $LIBCURL_NAME $LIBPCRE2_NAME"
