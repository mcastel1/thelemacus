...
\end{itemize}
\item with a new \gls{route}: Press \inlinefigure{1.4}{figures/button-new-route.png}, enter the information in the \gls{route} frame, and press \inlinefigure{1.5}{figures/routeframe-transport-button.png}. 
\end{itemize}
\end{itemize}
