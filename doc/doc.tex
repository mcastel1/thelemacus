...
\hspace{\stretch{2}} \includegraphics[height=0.2\textwidth]{figures/logo-cnrs.png}
}
...
For macOS, \thel's installer can be downloaded  \href{\thelemacusurl}{here}: Click on the .pkg installer and \thel will be placed in your /Applications folder: click on it, and \thel will start.  
...
\setmenukeysmac
\keys{\cmd + O}, \keys{\cmd + S}, \keys{\cmd + \shift  + S } on macOS, and  
\setmenukeyswin
