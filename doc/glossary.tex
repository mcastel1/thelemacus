...
\newglossaryentry{azimuth}{
    name={azimuth},
    description={The angle formed by a \gls{route} with the local meridian at the \gls{route}'s starting \gls{position}},
}
\newglossaryentry{sextant}{
    name={sextant},
    description={An optical instrument which allows to measure the altitude of a celestial \gls{body} over the horizon},
}