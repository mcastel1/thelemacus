...
\begin{enumerate}
  ...
  \begin{itemize}
  \item by providing the time and speed of the ship, e.g.,from which  \thel will extract the length sailed,  
  \item by providing directly the length sailed by the ship  $15$ \ac{nm}. 
