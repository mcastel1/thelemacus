...
To obtain it, click on \inlinefigure{figures/position-button.png} in the main frame: the position will be added to the position list with label `Astronomical position', and the charts will display it, see \cref{fig-astronomical-position}. The error on the astronomical position will be shown as a circle around it, and added to the route list. 
...
\begin{figure}
  ...
  \caption{
    ...
    The crossing of the three routes (red, green and blue) yields the astronomical position (red dot).  
  }
\end{figure}
