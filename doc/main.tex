...
\begin{figure}
  \centering
  \includegraphics[width=0.9\textwidth]{figures/list-frame.png}
  \caption{
...
To enter a new sight, press on \includegraphics[height=\fontcharht\font`\B]{figures/sight-frame.png} 
