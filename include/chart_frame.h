...
public:
    ...
    vector<wxPoint> coastline_polygons_now/*, coastline_polygons_before*/, grid_points;
    vector<unsigned long long int> polygon_position_now/*, polygon_position_before*/, grid_positions;
