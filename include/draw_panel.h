...
public:
    ...
    PositionProjection /*the values of (x, y) at the beginning/end of the selection process with a rectangle*/*projection_start, *projection_end, /*the PositionProjections, in the Projection_tyes[0], relative to the maximal available value of the latitude and longitude in the coastline data*/p_ceil_min, p_floor_max;
;
