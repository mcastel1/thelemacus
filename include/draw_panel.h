...
public:
    ...
    PositionProjection /*the values of (x, y) at the beginning/end of the selection process with a rectangle*/*projection_start, *projection_end, /*the PositionProjections, in the Projection_types[0], relative to the maximal available value of the latitude and longitude in the coastline data*/*p_ceil_min, *p_floor_max;
;
    ...
    vector<wxPoint> reference_positions_route_list, points_position_list;
    ...
    void RenderSelectionRectangle(wxDC&, const wxColor&, const wxColor&);
