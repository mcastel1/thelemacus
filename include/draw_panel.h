...
public:
    ...
    String /*this is used to display on the chart the coordinates of a Position that is being dragged or of the reference_position of a Route that is being dragged at the current step of the drag process*/ label_dragged_object, /*text showing the coordinates of the current mouse position on draw_panel*/ label_position_now;
    ...
    vector<wxPoint> reference_positions_route_list, points_position_list_now/*, points_position_list_before*/;
