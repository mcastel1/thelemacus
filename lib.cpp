                    ...
                    if(((route.reference_position.phi) != M_PI_2) && ((route.reference_position.phi) != 3.0*M_PI_2)){
                        ...
                        t_a.value = atan((8*cos((route.reference_position).phi)*((cos((route.reference_position).phi)*cos((reference_position.lambda.value) - (route.reference_position.lambda.value))*sin(((reference_position).phi)) - cos(((reference_position).phi))*sin((route.reference_position).phi))*(cos(((reference_position).phi))*cos((route.reference_position).phi)*cos((reference_position.lambda.value) - (route.reference_position.lambda.value))*cot((omega.value)) - cos((route.omega.value))*csc((omega.value)) + cot((omega.value))*sin(((reference_position).phi))*sin((route.reference_position).phi)) +
                                                                                 abs(sin((reference_position.lambda.value) - (route.reference_position.lambda.value)))*cos((route.reference_position).phi)*sqrt(-(gsl_sf_pow_int(cos((route.omega.value)),2)*gsl_sf_pow_int(csc((omega.value)),2)) + gsl_sf_pow_int(cos((route.reference_position).phi),2)*gsl_sf_pow_int(cos((reference_position).lambda),2)*gsl_sf_pow_int(cos((route.reference_position).lambda),2)*gsl_sf_pow_int(sin(((reference_position).phi)),2) +
                                                                                                                                                                                                                2*cos((route.omega.value))*cot((omega.value))*csc((omega.value))*sin(((reference_position).phi))*sin((route.reference_position).phi) - gsl_sf_pow_int(cot((omega.value)),2)*gsl_sf_pow_int(sin(((reference_position).phi)),2)*gsl_sf_pow_int(sin((route.reference_position).phi),2) +
                                                                                                                                                                                                                2*cos(((reference_position).phi))*cos((route.reference_position).phi)*cos((reference_position.lambda.value) - (route.reference_position.lambda.value))*csc((omega.value))*(cos((route.omega.value))*cot((omega.value)) - csc((omega.value))*sin(((reference_position).phi))*sin((route.reference_position).phi)) +
                                                                                                                                                                                                                gsl_sf_pow_int(cos(((reference_position).phi)),2)*(-(gsl_sf_pow_int(cos((route.reference_position).phi),2)*gsl_sf_pow_int(cos((reference_position.lambda.value) - (route.reference_position.lambda.value)),2)*gsl_sf_pow_int(cot((omega.value)),2)) + gsl_sf_pow_int(sin((route.reference_position).phi),2)) +
                                         ...
                                         (gsl_sf_pow_int(cos((route.reference_position).phi),2)*(-6 + 2*cos(2*(reference_position.phi.value)) + 2*cos(2*(reference_position.lambda.value) - 2*(route.reference_position.lambda.value)) + cos(2*((reference_position.phi.value) + (reference_position.lambda.value) - (route.reference_position.lambda.value))) + cos(2*((reference_position.phi.value) - (reference_position.lambda.value) + (route.reference_position.lambda.value)))) - 8*gsl_sf_pow_int(cos(((reference_position).phi)),2)*gsl_sf_pow_int(sin((route.reference_position).phi),2) +
                                          4*cos((reference_position.lambda.value) - (route.reference_position.lambda.value))*sin(2*(reference_position.phi.value))*sin(2*(route.reference_position.phi.value))),(8*gsl_sf_pow_int(cos((route.reference_position).phi),2)*(cos(((reference_position).phi))*cos((route.reference_position).phi)*cos((reference_position.lambda.value) - (route.reference_position.lambda.value))*cot((omega.value)) - cos((route.omega.value))*csc((omega.value)) + cot((omega.value))*sin(((reference_position).phi))*sin((route.reference_position).phi))*
                                                                                                                                                                                                                 ...
                                                                                                                                                                                                                 sqrt(-(gsl_sf_pow_int(cos((route.omega.value)),2)*gsl_sf_pow_int(csc((omega.value)),2)) + gsl_sf_pow_int(cos((route.reference_position).phi),2)*gsl_sf_pow_int(cos((reference_position).lambda),2)*gsl_sf_pow_int(cos((route.reference_position).lambda),2)*gsl_sf_pow_int(sin(((reference_position).phi)),2) + 2*cos((route.omega.value))*cot((omega.value))*csc((omega.value))*sin(((reference_position).phi))*sin((route.reference_position).phi) -
                                                                                                                                                                                                                      gsl_sf_pow_int(cot((omega.value)),2)*gsl_sf_pow_int(sin(((reference_position).phi)),2)*gsl_sf_pow_int(sin((route.reference_position).phi),2) + 2*cos(((reference_position).phi))*cos((route.reference_position).phi)*cos((reference_position.lambda.value) - (route.reference_position.lambda.value))*csc((omega.value))*(cos((route.omega.value))*cot((omega.value)) - csc((omega.value))*sin(((reference_position).phi))*sin((route.reference_position).phi)) +
                                                                                                                                                                                                                      gsl_sf_pow_int(cos(((reference_position).phi)),2)*(-(gsl_sf_pow_int(cos((route.reference_position).phi),2)*gsl_sf_pow_int(cos((reference_position.lambda.value) - (route.reference_position.lambda.value)),2)*gsl_sf_pow_int(cot((omega.value)),2)) + gsl_sf_pow_int(sin((route.reference_position).phi),2)) + gsl_sf_pow_int(cos((route.reference_position).phi),2)*gsl_sf_pow_int(cos((route.reference_position).lambda),2)*gsl_sf_pow_int(sin((reference_position).lambda),2) -
                        ...
                        t_b.value = atan((-8*cos((route.reference_position).phi)*((-(cos((route.reference_position).phi)*cos((reference_position.lambda.value) - (route.reference_position.lambda.value))*sin(((reference_position).phi))) + cos(((reference_position).phi))*sin((route.reference_position).phi))*(cos(((reference_position).phi))*cos((route.reference_position).phi)*cos((reference_position.lambda.value) - (route.reference_position.lambda.value))*cot((omega.value)) - cos((route.omega.value))*csc((omega.value)) + cot((omega.value))*sin(((reference_position).phi))*sin((route.reference_position).phi)) +
                                                                                  abs(sin((reference_position.lambda.value) - (route.reference_position.lambda.value)))*cos((route.reference_position).phi)*sqrt(-(gsl_sf_pow_int(cos((route.omega.value)),2)*gsl_sf_pow_int(csc((omega.value)),2)) + gsl_sf_pow_int(cos((route.reference_position).phi),2)*gsl_sf_pow_int(cos((reference_position).lambda),2)*gsl_sf_pow_int(cos((route.reference_position).lambda),2)*gsl_sf_pow_int(sin(((reference_position).phi)),2) +
                                                                                                                                                                                                                 2*cos((route.omega.value))*cot((omega.value))*csc((omega.value))*sin(((reference_position).phi))*sin((route.reference_position).phi) - gsl_sf_pow_int(cot((omega.value)),2)*gsl_sf_pow_int(sin(((reference_position).phi)),2)*gsl_sf_pow_int(sin((route.reference_position).phi),2) +
                                                                                                                                                                                                                 2*cos(((reference_position).phi))*cos((route.reference_position).phi)*cos((reference_position.lambda.value) - (route.reference_position.lambda.value))*csc((omega.value))*(cos((route.omega.value))*cot((omega.value)) - csc((omega.value))*sin(((reference_position).phi))*sin((route.reference_position).phi)) +
                                                                                                                                                                                                                 gsl_sf_pow_int(cos(((reference_position).phi)),2)*(-(gsl_sf_pow_int(cos((route.reference_position).phi),2)*gsl_sf_pow_int(cos((reference_position.lambda.value) - (route.reference_position.lambda.value)),2)*gsl_sf_pow_int(cot((omega.value)),2)) + gsl_sf_pow_int(sin((route.reference_position).phi),2)) +
                                         ...
                                         (gsl_sf_pow_int(cos((route.reference_position).phi),2)*(-6 + 2*cos(2*(reference_position.phi.value)) + 2*cos(2*(reference_position.lambda.value) - 2*(route.reference_position.lambda.value)) + cos(2*((reference_position.phi.value) + (reference_position.lambda.value) - (route.reference_position.lambda.value))) + cos(2*((reference_position.phi.value) - (reference_position.lambda.value) + (route.reference_position.lambda.value)))) - 8*gsl_sf_pow_int(cos(((reference_position).phi)),2)*gsl_sf_pow_int(sin((route.reference_position).phi),2) +
                                          4*cos((reference_position.lambda.value) - (route.reference_position.lambda.value))*sin(2*(reference_position.phi.value))*sin(2*(route.reference_position.phi.value))),(8*cos((route.reference_position).phi)*sin((reference_position.lambda.value) - (route.reference_position.lambda.value))*
                                                                                                                                                                                                                 (cos((route.reference_position).phi)*(cos(((reference_position).phi))*cos((route.reference_position).phi)*cos((reference_position.lambda.value) - (route.reference_position.lambda.value))*cot((omega.value)) - cos((route.omega.value))*csc((omega.value)) + cot((omega.value))*sin(((reference_position).phi))*sin((route.reference_position).phi)) +
                                                                                                                                                                                                                  ...
                                                                                                                                                                                                                  sqrt(-(gsl_sf_pow_int(cos((route.omega.value)),2)*gsl_sf_pow_int(csc((omega.value)),2)) + gsl_sf_pow_int(cos((route.reference_position).phi),2)*gsl_sf_pow_int(cos((reference_position).lambda),2)*gsl_sf_pow_int(cos((route.reference_position).lambda),2)*gsl_sf_pow_int(sin(((reference_position).phi)),2) +
                                                                                                                                                                                                                       2*cos((route.omega.value))*cot((omega.value))*csc((omega.value))*sin(((reference_position).phi))*sin((route.reference_position).phi) - gsl_sf_pow_int(cot((omega.value)),2)*gsl_sf_pow_int(sin(((reference_position).phi)),2)*gsl_sf_pow_int(sin((route.reference_position).phi),2) +
                                                                                                                                                                                                                       2*cos(((reference_position).phi))*cos((route.reference_position).phi)*cos((reference_position.lambda.value) - (route.reference_position.lambda.value))*csc((omega.value))*(cos((route.omega.value))*cot((omega.value)) - csc((omega.value))*sin(((reference_position).phi))*sin((route.reference_position).phi)) +
                                                                                                                                                                                                                       gsl_sf_pow_int(cos(((reference_position).phi)),2)*(-(gsl_sf_pow_int(cos((route.reference_position).phi),2)*gsl_sf_pow_int(cos((reference_position.lambda.value) - (route.reference_position.lambda.value)),2)*gsl_sf_pow_int(cot((omega.value)),2)) + gsl_sf_pow_int(sin((route.reference_position).phi),2)) +
                                                                                                                                                                                                                       gsl_sf_pow_int(cos((route.reference_position).phi),2)*gsl_sf_pow_int(cos((route.reference_position).lambda),2)*gsl_sf_pow_int(sin((reference_position).lambda),2) - 2*gsl_sf_pow_int(cos((route.reference_position).phi),2)*cos((reference_position).lambda)*cos((route.reference_position).lambda)*sin((reference_position).lambda)*sin((route.reference_position).lambda) +
...
bool Route::crossing(Route route, vector<Position>* p, double* cos_crossing_angle, String prefix){
    ...
    if(!((type == String("c")) && (route.type == String("c")))){
        ...
        theta.set(String("angle between the two GPs"), acos(cos((reference_position .phi))*cos((route.reference_position).phi)*cos(((*this).reference_position.lambda.value) - (route.reference_position.lambda.value)) + sin((reference_position.phi))*sin((route.reference_position).phi)), prefix);
...
void DrawPanel::PaintNow(){
    ...
    (parent->text_position_now)->SetPosition(wxPoint(((parent->text_position_now)->GetPosition()).x, height_chart + 4*((wxGetApp().rectangle_display).GetWidth())*(length_border_over_length_screen.value)));
...
void DrawPanel::Draw_Mercator(void){
    ...
    for(
        ...
        (((route.reference_position).lambda).value) += delta_lambda){
            ...
            route.DrawOld(((plot->n_points_routes).value), wxGetApp().foreground_color, -1, this);
...
void  DrawPanel::ProjectionToDrawPanel_3D(Projection q, wxPoint *p){
    ...
    (p->x) = ((double)(position_plot_area.x)) + (1.0+(q.x)/x_max)*(((double)width_plot_area)/2.0);
    (p->y) = ((double)(position_plot_area.y)) + (1.0-(q.y)/y_max)*(((double)height_plot_area)/2.0);
...
ListFrame::ListFrame(MyApp* parent_in, const wxString& title, const wxString& message, const wxPoint& pos, const wxSize& size, String prefix) : wxFrame(NULL, wxID_ANY, title, pos, size){
    ...
    button_modify_position = new wxBitmapButton(panel, wxID_ANY, wxBitmap(my_image), wxDefaultPosition, wxSize(((wxGetApp().rectangle_display).GetWidth())*(size_small_button_over_width_screen.value), ((wxGetApp().rectangle_display).GetWidth())*(size_small_button_over_width_screen.value)), wxBU_EXACTFIT | wxSIMPLE_BORDER);
    ...
    button_modify_route = new wxBitmapButton(panel, wxID_ANY, wxBitmap(my_image), wxDefaultPosition, wxSize(((wxGetApp().rectangle_display).GetWidth())*(size_small_button_over_width_screen.value), ((wxGetApp().rectangle_display).GetWidth())*(size_small_button_over_width_screen.value)), wxBU_EXACTFIT | wxSIMPLE_BORDER);
    ...
    button_add_position = new wxButton(panel, wxID_ANY, "+", wxDefaultPosition, wxSize(((wxGetApp().rectangle_display).GetWidth())*(size_small_button_over_width_screen.value), ((wxGetApp().rectangle_display).GetWidth())*(size_small_button_over_width_screen.value)), wxBU_EXACTFIT | wxSIMPLE_BORDER);
