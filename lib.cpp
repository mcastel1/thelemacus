        ...
        if(/*this is the condition that *this and route intersect*/(d > Re*fabs((omega.value)- ((route.omega).value))) && (d < Re*((omega + (route.omega)).value))){
            ...
            t_a.value = atan((8*cos((route.reference_position).phi)*((cos((route.reference_position).phi)*cos(((*this).reference_position.lambda.value) - (route.reference_position.lambda.value))*sin((((*this).reference_position).phi)) - cos((((*this).reference_position).phi))*sin((route.reference_position).phi))*(cos((((*this).reference_position).phi))*cos((route.reference_position).phi)*cos(((*this).reference_position.lambda.value) - (route.reference_position.lambda.value))*cot(((*this).omega.value)) - cos((route.omega.value))*csc(((*this).omega.value)) + cot(((*this).omega.value))*sin((((*this).reference_position).phi))*sin((route.reference_position).phi)) +
                                                                           abs(sin(((*this).reference_position.lambda.value) - (route.reference_position.lambda.value)))*cos((route.reference_position).phi)*sqrt(-(gsl_sf_pow_int(cos((route.omega.value)),2)*gsl_sf_pow_int(csc(((*this).omega.value)),2)) + gsl_sf_pow_int(cos((route.reference_position).phi),2)*gsl_sf_pow_int(cos(((*this).reference_position).lambda),2)*gsl_sf_pow_int(cos((route.reference_position).lambda),2)*gsl_sf_pow_int(sin((((*this).reference_position).phi)),2) +
                                                                                                                                                                                                                        2*cos((route.omega.value))*cot(((*this).omega.value))*csc(((*this).omega.value))*sin((((*this).reference_position).phi))*sin((route.reference_position).phi) - gsl_sf_pow_int(cot(((*this).omega.value)),2)*gsl_sf_pow_int(sin((((*this).reference_position).phi)),2)*gsl_sf_pow_int(sin((route.reference_position).phi),2) +
                                                                                                                                                                                                                        2*cos((((*this).reference_position).phi))*cos((route.reference_position).phi)*cos(((*this).reference_position.lambda.value) - (route.reference_position.lambda.value))*csc(((*this).omega.value))*(cos((route.omega.value))*cot(((*this).omega.value)) - csc(((*this).omega.value))*sin((((*this).reference_position).phi))*sin((route.reference_position).phi)) +
                                                                                                                                                                                                                        gsl_sf_pow_int(cos((((*this).reference_position).phi)),2)*(-(gsl_sf_pow_int(cos((route.reference_position).phi),2)*gsl_sf_pow_int(cos(((*this).reference_position.lambda.value) - (route.reference_position.lambda.value)),2)*gsl_sf_pow_int(cot(((*this).omega.value)),2)) + gsl_sf_pow_int(sin((route.reference_position).phi),2)) +
                                                                                                                                                                                                                        gsl_sf_pow_int(cos((route.reference_position).phi),2)*gsl_sf_pow_int(cos((route.reference_position).lambda),2)*gsl_sf_pow_int(sin(((*this).reference_position).lambda),2) - 2*gsl_sf_pow_int(cos((route.reference_position).phi),2)*cos(((*this).reference_position).lambda)*cos((route.reference_position).lambda)*sin(((*this).reference_position).lambda)*sin((route.reference_position).lambda) +
                                                                                                                                                                                                                        2*gsl_sf_pow_int(cos((route.reference_position).phi),2)*cos(((*this).reference_position).lambda)*cos((route.reference_position).lambda)*gsl_sf_pow_int(sin((((*this).reference_position).phi)),2)*sin(((*this).reference_position).lambda)*sin((route.reference_position).lambda) + gsl_sf_pow_int(cos((route.reference_position).phi),2)*gsl_sf_pow_int(cos(((*this).reference_position).lambda),2)*gsl_sf_pow_int(sin((route.reference_position).lambda),2) +
                                                                                                                                                                                                                        gsl_sf_pow_int(cos((route.reference_position).phi),2)*gsl_sf_pow_int(sin((((*this).reference_position).phi)),2)*gsl_sf_pow_int(sin(((*this).reference_position).lambda),2)*gsl_sf_pow_int(sin((route.reference_position).lambda),2))))/
                             (gsl_sf_pow_int(cos((route.reference_position).phi),2)*(-6 + 2*cos(2*((*this).reference_position.phi.value)) + 2*cos(2*((*this).reference_position.lambda.value) - 2*(route.reference_position.lambda.value)) + cos(2*(((*this).reference_position.phi.value) + ((*this).reference_position.lambda.value) - (route.reference_position.lambda.value))) + cos(2*(((*this).reference_position.phi.value) - ((*this).reference_position.lambda.value) + (route.reference_position.lambda.value)))) - 8*gsl_sf_pow_int(cos((((*this).reference_position).phi)),2)*gsl_sf_pow_int(sin((route.reference_position).phi),2) +
                              4*cos(((*this).reference_position.lambda.value) - (route.reference_position.lambda.value))*sin(2*((*this).reference_position.phi.value))*sin(2*(route.reference_position.phi.value))),(8*gsl_sf_pow_int(cos((route.reference_position).phi),2)*(cos((((*this).reference_position).phi))*cos((route.reference_position).phi)*cos(((*this).reference_position.lambda.value) - (route.reference_position.lambda.value))*cot(((*this).omega.value)) - cos((route.omega.value))*csc(((*this).omega.value)) + cot(((*this).omega.value))*sin((((*this).reference_position).phi))*sin((route.reference_position).phi))*
                                                                                                                                                                                                                     sin(((*this).reference_position.lambda.value) - (route.reference_position.lambda.value)) - 8*abs(sin(((*this).reference_position.lambda.value) - (route.reference_position.lambda.value)))*cos((route.reference_position).phi)*csc(((*this).reference_position.lambda.value) - (route.reference_position.lambda.value))*(cos((route.reference_position).phi)*cos(((*this).reference_position.lambda.value) - (route.reference_position.lambda.value))*sin((((*this).reference_position).phi)) - cos((((*this).reference_position).phi))*sin((route.reference_position).phi))*
                                                                                                                                                                                                                     sqrt(-(gsl_sf_pow_int(cos((route.omega.value)),2)*gsl_sf_pow_int(csc(((*this).omega.value)),2)) + gsl_sf_pow_int(cos((route.reference_position).phi),2)*gsl_sf_pow_int(cos(((*this).reference_position).lambda),2)*gsl_sf_pow_int(cos((route.reference_position).lambda),2)*gsl_sf_pow_int(sin((((*this).reference_position).phi)),2) + 2*cos((route.omega.value))*cot(((*this).omega.value))*csc(((*this).omega.value))*sin((((*this).reference_position).phi))*sin((route.reference_position).phi) -
                                                                                                                                                                                                                          gsl_sf_pow_int(cot(((*this).omega.value)),2)*gsl_sf_pow_int(sin((((*this).reference_position).phi)),2)*gsl_sf_pow_int(sin((route.reference_position).phi),2) + 2*cos((((*this).reference_position).phi))*cos((route.reference_position).phi)*cos(((*this).reference_position.lambda.value) - (route.reference_position.lambda.value))*csc(((*this).omega.value))*(cos((route.omega.value))*cot(((*this).omega.value)) - csc(((*this).omega.value))*sin((((*this).reference_position).phi))*sin((route.reference_position).phi)) +
                                                                                                                                                                                                                          gsl_sf_pow_int(cos((((*this).reference_position).phi)),2)*(-(gsl_sf_pow_int(cos((route.reference_position).phi),2)*gsl_sf_pow_int(cos(((*this).reference_position.lambda.value) - (route.reference_position.lambda.value)),2)*gsl_sf_pow_int(cot(((*this).omega.value)),2)) + gsl_sf_pow_int(sin((route.reference_position).phi),2)) + gsl_sf_pow_int(cos((route.reference_position).phi),2)*gsl_sf_pow_int(cos((route.reference_position).lambda),2)*gsl_sf_pow_int(sin(((*this).reference_position).lambda),2) -
                                                                                                                                                                                                                          2*gsl_sf_pow_int(cos((route.reference_position).phi),2)*cos(((*this).reference_position).lambda)*cos((route.reference_position).lambda)*sin(((*this).reference_position).lambda)*sin((route.reference_position).lambda) + 2*gsl_sf_pow_int(cos((route.reference_position).phi),2)*cos(((*this).reference_position).lambda)*cos((route.reference_position).lambda)*gsl_sf_pow_int(sin((((*this).reference_position).phi)),2)*sin(((*this).reference_position).lambda)*sin((route.reference_position).lambda) +
                                                                                                                                                                                                                          gsl_sf_pow_int(cos((route.reference_position).phi),2)*gsl_sf_pow_int(cos(((*this).reference_position).lambda),2)*gsl_sf_pow_int(sin((route.reference_position).lambda),2) + gsl_sf_pow_int(cos((route.reference_position).phi),2)*gsl_sf_pow_int(sin((((*this).reference_position).phi)),2)*gsl_sf_pow_int(sin(((*this).reference_position).lambda),2)*gsl_sf_pow_int(sin((route.reference_position).lambda),2)))/
                             (gsl_sf_pow_int(cos((route.reference_position).phi),2)*(-6 + 2*cos(2*((*this).reference_position.phi.value)) + 2*cos(2*((*this).reference_position.lambda.value) - 2*(route.reference_position.lambda.value)) + cos(2*(((*this).reference_position.phi.value) + ((*this).reference_position.lambda.value) - (route.reference_position.lambda.value))) + cos(2*(((*this).reference_position.phi.value) - ((*this).reference_position.lambda.value) + (route.reference_position.lambda.value)))) - 8*gsl_sf_pow_int(cos((((*this).reference_position).phi)),2)*gsl_sf_pow_int(sin((route.reference_position).phi),2) +
            ...
            t_b.value = atan((-8*cos((route.reference_position).phi)*((-(cos((route.reference_position).phi)*cos(((*this).reference_position.lambda.value) - (route.reference_position.lambda.value))*sin((((*this).reference_position).phi))) + cos((((*this).reference_position).phi))*sin((route.reference_position).phi))*(cos((((*this).reference_position).phi))*cos((route.reference_position).phi)*cos(((*this).reference_position.lambda.value) - (route.reference_position.lambda.value))*cot(((*this).omega.value)) - cos((route.omega.value))*csc(((*this).omega.value)) + cot(((*this).omega.value))*sin((((*this).reference_position).phi))*sin((route.reference_position).phi)) +
                                                                            abs(sin(((*this).reference_position.lambda.value) - (route.reference_position.lambda.value)))*cos((route.reference_position).phi)*sqrt(-(gsl_sf_pow_int(cos((route.omega.value)),2)*gsl_sf_pow_int(csc(((*this).omega.value)),2)) + gsl_sf_pow_int(cos((route.reference_position).phi),2)*gsl_sf_pow_int(cos(((*this).reference_position).lambda),2)*gsl_sf_pow_int(cos((route.reference_position).lambda),2)*gsl_sf_pow_int(sin((((*this).reference_position).phi)),2) +
                                                                                                                                                                                                                         2*cos((route.omega.value))*cot(((*this).omega.value))*csc(((*this).omega.value))*sin((((*this).reference_position).phi))*sin((route.reference_position).phi) - gsl_sf_pow_int(cot(((*this).omega.value)),2)*gsl_sf_pow_int(sin((((*this).reference_position).phi)),2)*gsl_sf_pow_int(sin((route.reference_position).phi),2) +
                                                                                                                                                                                                                         2*cos((((*this).reference_position).phi))*cos((route.reference_position).phi)*cos(((*this).reference_position.lambda.value) - (route.reference_position.lambda.value))*csc(((*this).omega.value))*(cos((route.omega.value))*cot(((*this).omega.value)) - csc(((*this).omega.value))*sin((((*this).reference_position).phi))*sin((route.reference_position).phi)) +
                                                                                                                                                                                                                         gsl_sf_pow_int(cos((((*this).reference_position).phi)),2)*(-(gsl_sf_pow_int(cos((route.reference_position).phi),2)*gsl_sf_pow_int(cos(((*this).reference_position.lambda.value) - (route.reference_position.lambda.value)),2)*gsl_sf_pow_int(cot(((*this).omega.value)),2)) + gsl_sf_pow_int(sin((route.reference_position).phi),2)) +
                             ...
                             (gsl_sf_pow_int(cos((route.reference_position).phi),2)*(-6 + 2*cos(2*((*this).reference_position.phi.value)) + 2*cos(2*((*this).reference_position.lambda.value) - 2*(route.reference_position.lambda.value)) + cos(2*(((*this).reference_position.phi.value) + ((*this).reference_position.lambda.value) - (route.reference_position.lambda.value))) + cos(2*(((*this).reference_position.phi.value) - ((*this).reference_position.lambda.value) + (route.reference_position.lambda.value)))) - 8*gsl_sf_pow_int(cos((((*this).reference_position).phi)),2)*gsl_sf_pow_int(sin((route.reference_position).phi),2) +
                              4*cos(((*this).reference_position.lambda.value) - (route.reference_position.lambda.value))*sin(2*((*this).reference_position.phi.value))*sin(2*(route.reference_position.phi.value))),(8*cos((route.reference_position).phi)*sin(((*this).reference_position.lambda.value) - (route.reference_position.lambda.value))*
                                                                                                                                                                                                                     (cos((route.reference_position).phi)*(cos((((*this).reference_position).phi))*cos((route.reference_position).phi)*cos(((*this).reference_position.lambda.value) - (route.reference_position.lambda.value))*cot(((*this).omega.value)) - cos((route.omega.value))*csc(((*this).omega.value)) + cot(((*this).omega.value))*sin((((*this).reference_position).phi))*sin((route.reference_position).phi)) +
                                                                                                                                                                                                                      abs(sin(((*this).reference_position.lambda.value) - (route.reference_position.lambda.value)))*gsl_sf_pow_int(csc(((*this).reference_position.lambda.value) - (route.reference_position.lambda.value)),2)*(cos((route.reference_position).phi)*cos(((*this).reference_position.lambda.value) - (route.reference_position.lambda.value))*sin((((*this).reference_position).phi)) - cos((((*this).reference_position).phi))*sin((route.reference_position).phi))*
                                                                                                                                                                                                                      sqrt(-(gsl_sf_pow_int(cos((route.omega.value)),2)*gsl_sf_pow_int(csc(((*this).omega.value)),2)) + gsl_sf_pow_int(cos((route.reference_position).phi),2)*gsl_sf_pow_int(cos(((*this).reference_position).lambda),2)*gsl_sf_pow_int(cos((route.reference_position).lambda),2)*gsl_sf_pow_int(sin((((*this).reference_position).phi)),2) +
                                                                                                                                                                                                                           2*cos((route.omega.value))*cot(((*this).omega.value))*csc(((*this).omega.value))*sin((((*this).reference_position).phi))*sin((route.reference_position).phi) - gsl_sf_pow_int(cot(((*this).omega.value)),2)*gsl_sf_pow_int(sin((((*this).reference_position).phi)),2)*gsl_sf_pow_int(sin((route.reference_position).phi),2) +
                                                                                                                                                                                                                           2*cos((((*this).reference_position).phi))*cos((route.reference_position).phi)*cos(((*this).reference_position.lambda.value) - (route.reference_position.lambda.value))*csc(((*this).omega.value))*(cos((route.omega.value))*cot(((*this).omega.value)) - csc(((*this).omega.value))*sin((((*this).reference_position).phi))*sin((route.reference_position).phi)) +
                                                                                                                                                                                                                           gsl_sf_pow_int(cos((((*this).reference_position).phi)),2)*(-(gsl_sf_pow_int(cos((route.reference_position).phi),2)*gsl_sf_pow_int(cos(((*this).reference_position.lambda.value) - (route.reference_position.lambda.value)),2)*gsl_sf_pow_int(cot(((*this).omega.value)),2)) + gsl_sf_pow_int(sin((route.reference_position).phi),2)) +
                                                                                                                                                                                                                           gsl_sf_pow_int(cos((route.reference_position).phi),2)*gsl_sf_pow_int(cos((route.reference_position).lambda),2)*gsl_sf_pow_int(sin(((*this).reference_position).lambda),2) - 2*gsl_sf_pow_int(cos((route.reference_position).phi),2)*cos(((*this).reference_position).lambda)*cos((route.reference_position).lambda)*sin(((*this).reference_position).lambda)*sin((route.reference_position).lambda) +
...
bool Route::crossing(Route route, vector<Position>* p, double* cos_crossing_angle, String prefix){
    ...
    if(!(((*this).type == String("c")) && (route.type == String("c")))){
        ...
        theta.set(String("angle between the two GPs"), acos(cos((((*this).reference_position).phi))*cos((route.reference_position).phi)*cos(((*this).reference_position.lambda.value) - (route.reference_position.lambda.value)) + sin((((*this).reference_position).phi))*sin((route.reference_position).phi)), prefix);
        ...
        if((abs(((*this).omega.value)-(route.omega.value)) < (theta.value)) && ((theta.value) < ((*this).omega.value)+(route.omega.value))){
            ...
            if(check){
                ...
                (cos(((*this).reference_position).lambda)*cos(t[0]) + sin((((*this).reference_position).phi))*sin(((*this).reference_position).lambda)*sin(t[0]))*(cos((route.reference_position).lambda)*cos(u[0]) + sin((route.reference_position).phi)*sin((route.reference_position).lambda)*sin(u[0]));
...
bool DrawPanel::ScreenToGeo_3D(wxPoint p, Position *q){
    ...
    if(ScreenTo3D(p, &temp)){
        ...
        if(q!=NULL){
            ...
            gsl_vector_set(rp, 2, (-(temp.x)*sqrt(arg_sqrt)*(temp.y) + (d.value)*((d.value) + 1.0)*(temp.x)*(temp.y))/((temp.x)*(gsl_sf_pow_int((d.value),2) + gsl_sf_pow_int((temp.x),2) + gsl_sf_pow_int((temp.y),2))));
