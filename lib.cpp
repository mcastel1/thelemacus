...
ChartFrame::ChartFrame(ListFrame* parent_input, const wxString& title, const wxPoint& pos, const wxSize& size, String prefix) : wxFrame(parent_input, wxID_ANY, title, pos, size){
    ...
    value_slider_old = 1;
    //allocate the slider
    slider = new wxSlider(panel, wxID_ANY, floor_log(value_slider_old), floor_log(1), floor_log(value_slider_max.value), wxDefaultPosition, wxDefaultSize, wxSL_VERTICAL);
