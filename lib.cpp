...
void DrawPanel::Render_Mercator(wxDC&  dc){
    ...
    //                               + ((parent->parent->parent->rectangle_display).GetWidth())*(length_border_over_length_screen.value),
    //                               0);
    //
    //            first_label = false;
    //
...
template<class P> template <class T> void CheckLengthValue<P>::operator()(T &event){
    ...
    if(!(f->idling)){
        ...
        if(check || ((((p->value)->GetBackgroundColour()) == *wxWHITE) && (String((((p->value)->GetValue()).ToStdString())) == String("")))){
...
template<class P> template <class T> void CheckLengthUnit<P>::operator()(T &event){
    ...
    if(!(f->idling)){
        ...
        if(check || ((((p->unit)->GetBackgroundColour()) == *wxWHITE) && (String((((p->unit)->GetValue()).ToStdString())) == String("")))){
