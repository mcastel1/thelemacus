...
public:
    ...
    String /*the labels that will be drawn on position_start_label_selection_rectangle and position_end_label_selection_rectangle, respectively*/start_label_selection_rectangle, end_label_selection_rectangle, /*this is used to display on the chart the coordinates of a Position that is being dragged or of the reference position of a Route that is being dragged*/label_dragged_position, /*text showing the coordinates of the current mouse position on draw_panel*/ label_position_now;
;
