...
public:
    ...
    Position /*I store in this Position the starting Position (ground position) of a Route if the Route is a loxodrome or orthodrome (circle of equal altitude) that I want to drag, at the current step (route_reference_position_drag_now) and at the preceeding step (route_reference_position_drag_before) of the dragging process*/route_reference_position_drag_now, route_reference_position_drag_before, /*starting and ending geographic position in a mouse drag process*/  geo_start_drag, geo_end_drag, /*the position on the sphere such that the vector between the center of the sphere and the position equals the direction of the rotation axis relative to a mouse drag*/rotation_axis, /*the geographic positions corresponding to the NW (SE) boundary of of the plot area, moved to the interior of the plot area by one pixel. These will be used to plot parallels and meridians in such a way that they don't hit the boundary of the plot area*/p_NW, p_SE;
