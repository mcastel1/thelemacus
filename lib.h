...
public:
    ...
    Angle rotation_angle, /*an angle containing the middle longitude of the current 3D projection, used for drawing things in the middle of the projection*/lambda_middle;
