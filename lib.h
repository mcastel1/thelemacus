...
public:
    ...
    FileRW data_file;
    unsigned int margin;
    int /*the # of the sight/route/position which is highlighted because the mouse is hovering over it in listcontrol_sights/routes/positions*/highlighted_sight, highlighted_route_now, highlighted_route_before,  highlighted_position, /*# of the object to transport or disconnect */i_object_to_transport, i_object_to_disconnect, i_transporting_route;
