...
public:
    ...
    String text_position_start, text_position_end, /*this is used to display on the chart the coordinates of a Position that is being dragged or of the reference position of a Route that is being dragged*/text_geo_position;
