...
//    GraphicalFeatureTransportHandler* transport_handler;
    ...
    //this vector containts the ids (as written in coastline_polygons_Position/Cartesian) of the polygons which have at least one point falling into rectangle_observer, and it is updated every time rectangle_observer changes
    vector<unsigned long long int> coastline_polygons_map_rectangle_observer;
