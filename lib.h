...
public:
    ...
    vector<wxPoint> reference_positions_route_list_now, reference_positions_route_list_before;
    ...
    void RenderRoutes(wxDC&, vector< vector< vector<wxPoint> > >, vector<wxPoint>, wxColor, wxColor);
