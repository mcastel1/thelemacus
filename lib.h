...
public:
    ...
    Angle rotation_angle, /*an angle containing the middle longitude of the current 3D projection, rounded up to the closest value which is a multiple of delta_lambda, used for drawing things in the middle of the projection*/lambda_middle, phi_start, phi_end;
