...
#define path_file_init "sight_gui_app.app/Contents/Resources/init.txt"
#define path_file_catalog "sight_gui_app.app/Contents/Resources/catalog.txt"
...
bool Sight::check_data_time_interval(String prefix){
    ...
    temp.clear();
    if((body.type.value) != "star"){
        temp << "sight_gui_app.app/Contents/Resources/" << body.name.value << ".txt";
    }else{
        temp << "sight_gui_app.app/Contents/Resources/j2000_to_itrf93.txt";
    }
...
bool Sight::enter(Catalog catalog, String name, String prefix){
    ...
    do{
        ...
        //read TAI_minus_UTC from sight_gui_app.app/Contents/Resources/index.txt
...
bool Sight::get_coordinates(Route* circle_of_equal_altitude, String prefix){
    ...
    if((body.type.value) != "star"){
        filename << "sight_gui_app.app/Contents/Resources/" << body.name.value << ".txt";
    }else{
        filename << "sight_gui_app.app/Contents/Resources/j2000_to_itrf93.txt";
    }
    temp = filename.str();
