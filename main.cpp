...
/*
 ...
 - when you draw parallels in the 3d projeciton, avoid omega > pi/2 by changing reference_position.phi along the loop
 in  Route::intersection replace computation of theta with Position::distance
 */
