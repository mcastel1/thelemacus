 ...
 ********** THINGS TO FIX ************
     ...
     - all GUI fields which are a dropdown menu with a limited number of choices (ProjectionField, LengthFormatField, RouteTypeField, BodyField) must be defined in terms of the parent class MultipleItemField
on WIN32:
