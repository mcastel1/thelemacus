...
bool MyApp::OnInit() {
    ...
    r = Route(Route_types[1], Position(Angle(2.32), Angle(1.13)), Angle(2.43), Length(3000.32));
...
//    n_recent_speed_units.read_from_file_to(String("number of recent speed units"), (wxGetApp().path_file_init), String("R"), String(""));
    ...
    if(!(list_frame->abort)){
        ...
        disclaimer = new QuestionFrame< ShowAll , CloseApp >(NULL, show_all, String("Yes"), close_app, String("No"),
