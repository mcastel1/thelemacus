...
public:
    ...
    Int time_zone, zoom_factor_max, n_points_minor_ticks, /*the size of borders in pixels*/border, /*the size in pixels of the points used, for example, to draw coastlines */point_size, /*the number of recent bodies, projections, ... in dropdown menus*/n_recent_bodies, n_recent_length_formats, n_recent_projections, n_recent_route_types, n_recent_length_units, /*the number of snapshots used in animations*/n_animation_steps;
