...
public:
    ...
    String path_file_utc_date_and_time, path_file_init, path_file_recent, path_file_catalog, path_file_temp, path_file_app_icon, path_file_error_icon, path_file_warning_icon, path_file_plus_icon, path_file_list_icon, path_file_map_icon, path_file_pencil_icon, path_file_trash_icon, path_file_arrow_icon, path_file_coastline_data_blocked, path_file_n_line, default_open_directory;
