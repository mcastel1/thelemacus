...
public:
    ...
    String default_open_directory, data_directory, image_directory, path_file_init, path_file_recent, path_file_catalog, path_file_sample_sight, path_file_app_icon, path_file_error_icon, path_file_warning_icon, path_file_question_icon, path_file_info_icon, path_file_plus_icon, path_file_list_icon, path_file_position_icon, path_file_map_icon, path_file_pencil_icon, path_file_trash_icon, path_file_arrow_icon, path_file_disconnect_icon, path_file_michele_icon, path_coastline_file, path_file_n_line, /*the root directory of the application*/root_directory;
