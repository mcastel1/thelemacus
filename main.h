...
public:
    ...
    Int time_zone, zoom_factor_max, n_points_minor_ticks, /*the size of borders in pixels*/border, /*the size in pixels of the points used, for example, to draw coastlines */point_size;
    ...
    String default_open_directory, code_directory, data_directory, image_directory, path_file_utc_date_and_time, path_file_init, path_file_recent, path_file_catalog, path_file_temp, path_file_app_icon, path_file_error_icon, path_file_warning_icon, path_file_question_icon, path_file_plus_icon, path_file_list_icon, path_file_position_icon, path_file_map_icon, path_file_pencil_icon, path_file_trash_icon, path_file_arrow_icon, path_file_disconnect_icon, path_file_coastline_data_blocked, path_file_n_line, /*the root directory of the application*/root_directory;
