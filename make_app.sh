...
#install_name_tool -change /usr/lib/libz.1.dylib @rpath/libz.1.dylib  $APP_LIBRARY_DIRECTORY/$LIB_A
#install_name_tool -change $WXWIDGETS_LIB_DIRECTORY/libwx_osx_cocoau_html-3.2.0.2.2.dylib @rpath/libwx_osx_cocoau_html-3.2.0.2.2.dylib  $APP_LIBRARY_DIRECTORY/$LIB_A
#install_name_tool -change $WXWIDGETS_LIB_DIRECTORY/libwx_baseu_xml-3.2.0.2.2.dylib @rpath/libwx_baseu_xml-3.2.0.2.2.dylib $APP_LIBRARY_DIRECTORY/$LIB_A
#install_name_tool -change $WXWIDGETS_LIB_DIRECTORY/libwx_baseu-3.2.0.2.2.dylib @rpath/libwx_baseu-3.2.0.2.2.dylib $APP_LIBRARY_DIRECTORY/$LIB_A
#install_name_tool -change /usr/local/opt/libpng/lib/libpng16.16.dylib @rpath/libpng16.16.dylib $APP_LIBRARY_DIRECTORY/$LIB_A
#install_name_tool -change /usr/local/opt/jpeg/lib/libjpeg.9.dylib @rpath/libjpeg.9.dylib $APP_LIBRARY_DIRECTORY/$LIB_A
#install_name_tool -change $LIBTIFF_LIB_DIRECTORY/libtiff.6.dylib @rpath/libtiff.6.dylib $APP_LIBRARY_DIRECTORY/$LIB_A
##install_name_tool -change /usr/local/opt/xz/lib/liblzma.5.dylib @rpath/liblzma.5.dylib $APP_LIBRARY_DIRECTORY/$LIB_A
