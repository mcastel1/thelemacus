...
install_name_tool -add_rpath @executable_path/../Resources/Libraries/ $APP_LIBRARY_DIRECTORY/libpng16.16.dylib
install_name_tool -change /usr/lib/libz.1.dylib @rpath/libz.1.dylib  $APP_LIBRARY_DIRECTORY/libpng16.16.dylib
