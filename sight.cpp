...
/*
 ...
 g++ sight.cpp -o sight.o `wx-config --cxxflags --libs`
 g++ sight.cpp -o sight.o `wx-config --cxxflags --libs` -lgsl -lcblas -I/usr/local/include/gsl/ -Wall -Wno-c++11-extensions
