...
void Data::print(bool print_all_routes, String prefix, ostream& ostr) {
    ...
    print_recent_items(recent_Rout_types_for_transport, String("route for transport types"), prefix, ostr);
...
template<class S> void Data::read_from_stream(String name, S* input_stream, bool search_entire_stream, [[maybe_unused]] String prefix) {
    ...
    read_list_from_stream<S>(String("Recent route for transport types"), input_stream, true, &recent_Rout_types_for_transport);
...
template void Data::read_from_stream< basic_istringstream<char,struct char_traits<char>, allocator<char> > >( String, basic_istringstream<char,struct char_traits<char>, allocator<char> > *,bool, String);
