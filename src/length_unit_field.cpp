...
template<class P> LengthUnitField<P>::LengthUnitField(wxPanel* panel_of_parent, LengthUnit* object_in, vector<int>* recent_items_in) : MultipleItemField<P, LengthUnit, CheckUnit<P, LengthField<P>> >(panel_of_parent, object_in, LengthUnit_types, recent_items_in) {
