...
ListFrame::ListFrame(const wxString& title, [[maybe_unused]] const wxString& message, const wxPoint& pos, const wxSize& size, [[maybe_unused]] String prefix) : wxFrame(NULL, wxID_ANY, title, pos, size) {
    ...
    highlight_route_and_disconnect_sight = new HighlightObject<ListFrame, DisconnectSightAndUnsetIdling>(this, &highlighted_route_before, &highlighted_route_now, disconnect_sight);
...
template<class E> void ListFrame::OnPressDeleteRoute(E& event) {
    ...
    QuestionFrame<ListFrame, AskRemoveRelatedSight, UnsetIdling<ListFrame>, UnsetIdling<ListFrame>>* question_frame = new QuestionFrame<ListFrame, AskRemoveRelatedSight, UnsetIdling<ListFrame>, UnsetIdling<ListFrame>>(
                                                                                                                                                                                                                          this,
                                                                                                                                                                                                                          ask_remove_related_sight,
                                                                                                                                                                                                                          String("Yes"), unset_idling, String("No"), unset_idling, true, true, true,
                                                                                                                                                                                                                "",
                                                                                                                                                                                                                "Do you really want to remove this route?",           wxGetApp().path_file_question_icon, wxDefaultPosition, wxDefaultSize, String(""));
